...
@implementation TestChatViewModel

-(instancetype)initWithChatMode:(XMNChatMode)aChatMode{
    if (self = [super initWithChatMode:aChatMode]) {
        [self insertSystemMessage];     //系统通知消息
//        [self insertTextMessage];       //文本消息
//        [self insertImageMessage];      //图片消息
        
//        self.chatServer = [[TestChatServer alloc] init];
...
-(void)insertSystemMessage{
    ...
    XMNChatSystemMessage *systemMessage = [[XMNChatSystemMessage alloc] initWithContent:dateStr
