 ...
 *
 *  @_param key             the key describing the url
 *  @_param completionBlock the block to be executed when the check is done.
 ...
 *
 *  @_param key  the key (can be obtained from url using cacheKeyForURL)
 *  @_param path the cache path root folder
 *
