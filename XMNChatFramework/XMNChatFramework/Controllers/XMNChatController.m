...
- (void)setupConstraints {
    ...
    {//setup tableView constraints
        ...
        [self.view addConstraint:[NSLayoutConstraint constraintWithItem:self.tableView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeTop multiplier:1.0 constant:0.0f]]; //64.0f
...
-(void)setupChatOtherItemsDefault{
    ...
    [self.otherView setItems:@[item0,item1,item2,item3,item4,item5,item6,item7,item8,item9,item10,item11]];
    
}
- (void)setupChatOtherItems:(NSArray *)items{
    if ([items isKindOfClass:[NSArray class]]) {
        [self.otherView setItems:items];
    }
}
